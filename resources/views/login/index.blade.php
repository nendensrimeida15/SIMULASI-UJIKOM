			...
			<div class="main-signin-wrapper">
				...
				<div class="wd-md-50p login d-none d-md-block page-signin-style p-5 text-white" >
					<div class="my-auto authentication-pages">
						<div>
							...
							<h5 class="mb-4">Aplikasi Perpustakaan </h5>
							<p class="mb-5">perpustakaan ataupun rumah buku, adalah sebuah koleksi buku dan majalah. Perpustakaan dapat juga diartikan sebagai kumpulan informasi yang bersifat ilmu pengetahuan, hiburan, rekreasi, dan ibadah yang merupakan kebutuhan hakiki manusia.  </p>
				...
				<div class="sign-up-body wd-md-50p">
					<div class="main-signin-header">
						...
						<form action="/login/data-pengguna" method="get">
							...
							</div><button class="btn btn-primary btn-block">Login</button>
						</form>
					</div>
